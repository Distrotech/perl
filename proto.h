...
PERL_CALLCONV void	Perl_sv_ltrim(pTHX_ SV *const sv)
			__attribute__nonnull__(pTHX_1);
#define PERL_ARGS_ASSERT_SV_LTRIM	\
	assert(sv)
...
PERL_CALLCONV void	Perl_sv_rtrim(pTHX_ SV *const sv)
			__attribute__nonnull__(pTHX_1);
#define PERL_ARGS_ASSERT_SV_RTRIM	\
	assert(sv)
