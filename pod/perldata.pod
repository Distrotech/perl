...
integer formats:
    ...
    0b011011            # binary
    0x1.999ap-4         # hexadecimal floating point (the 'p' is essential)
...
Hexadecimal floating point is not supported if $Config{uselongdouble}
is defined or if $Config{uvsize} is less than $Config{nvsize} (32-bit
integers).
